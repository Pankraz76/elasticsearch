...
class KqlBaseParser extends Parser {
    ...
    public static final int DEFAULT_SKIP = 1, AND = 2, OR = 3, NOT = 4, COLON = 5, OP_LESS = 6, OP_LESS_EQ = 7, OP_MORE = 8, OP_MORE_EQ = 9,
        LEFT_PARENTHESIS = 10, RIGHT_PARENTHESIS = 11, LEFT_CURLY_BRACKET = 12, RIGHT_CURLY_BRACKET = 13, UNQUOTED_LITERAL = 14,
        QUOTED_STRING = 15, WILDCARD = 16;
    public static final int RULE_topLevelQuery = 0, RULE_query = 1, RULE_simpleQuery = 2, RULE_notQuery = 3, RULE_nestedQuery = 4,
        RULE_nestedSubQuery = 5, RULE_nestedSimpleSubQuery = 6, RULE_nestedParenthesizedQuery = 7, RULE_matchAllQuery = 8,
        RULE_parenthesizedQuery = 9, RULE_rangeQuery = 10, RULE_rangeQueryValue = 11, RULE_existsQuery = 12, RULE_fieldQuery = 13,
        RULE_fieldLessQuery = 14, RULE_fieldQueryValue = 15, RULE_fieldName = 16;
    ...
    private static String[] makeLiteralNames() {
        return new String[] { null, null, "'and'", "'or'", "'not'", "':'", "'<'", "'<='", "'>'", "'>='", "'('", "')'", "'{'", "'}'" };
    }
    ...
    public static class TopLevelQueryContext extends ParserRuleContext {
        public TerminalNode EOF() {
            return getToken(KqlBaseParser.EOF, 0);
        }
    ...
    public static class BooleanQueryContext extends QueryContext {
        ...
        public TerminalNode AND() {
            return getToken(KqlBaseParser.AND, 0);
        }

        public TerminalNode OR() {
            return getToken(KqlBaseParser.OR, 0);
        }

        public BooleanQueryContext(QueryContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class DefaultQueryContext extends QueryContext {
        ...
        public DefaultQueryContext(QueryContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class NotQueryContext extends ParserRuleContext {
        ...
        public TerminalNode NOT() {
            return getToken(KqlBaseParser.NOT, 0);
        }
    ...
    public static class NestedQueryContext extends ParserRuleContext {
        ...
        public TerminalNode COLON() {
            return getToken(KqlBaseParser.COLON, 0);
        }

        public TerminalNode LEFT_CURLY_BRACKET() {
            return getToken(KqlBaseParser.LEFT_CURLY_BRACKET, 0);
        }
        ...
        public TerminalNode RIGHT_CURLY_BRACKET() {
            return getToken(KqlBaseParser.RIGHT_CURLY_BRACKET, 0);
        }
    ...
    public static class BooleanNestedQueryContext extends NestedSubQueryContext {
        ...
        public BooleanNestedQueryContext(NestedSubQueryContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class DefaultNestedQueryContext extends NestedSubQueryContext {
        ...
        public DefaultNestedQueryContext(NestedSubQueryContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class NestedSimpleSubQueryContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_nestedSimpleSubQuery;
        }
    ...
    public static class NestedParenthesizedQueryContext extends ParserRuleContext {
        public TerminalNode LEFT_PARENTHESIS() {
            return getToken(KqlBaseParser.LEFT_PARENTHESIS, 0);
        }
        ...
        public TerminalNode RIGHT_PARENTHESIS() {
            return getToken(KqlBaseParser.RIGHT_PARENTHESIS, 0);
        }
        ...
        @Override
        public int getRuleIndex() {
            return RULE_nestedParenthesizedQuery;
        }
    ...
    public static class MatchAllQueryContext extends ParserRuleContext {
        public List<TerminalNode> WILDCARD() {
            return getTokens(KqlBaseParser.WILDCARD);
        }
    ...
    public static class ParenthesizedQueryContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_parenthesizedQuery;
        }
    ...
    public static class RangeQueryContext extends ParserRuleContext {
        ...
        public TerminalNode OP_LESS() {
            return getToken(KqlBaseParser.OP_LESS, 0);
        }

        public TerminalNode OP_LESS_EQ() {
            return getToken(KqlBaseParser.OP_LESS_EQ, 0);
        }

        public TerminalNode OP_MORE() {
            return getToken(KqlBaseParser.OP_MORE, 0);
        }

        public TerminalNode OP_MORE_EQ() {
            return getToken(KqlBaseParser.OP_MORE_EQ, 0);
        }
    ...
    public static class RangeQueryValueContext extends ParserRuleContext {
        public List<TerminalNode> UNQUOTED_LITERAL() {
            return getTokens(KqlBaseParser.UNQUOTED_LITERAL);
        }
        ...
        public TerminalNode QUOTED_STRING() {
            return getToken(KqlBaseParser.QUOTED_STRING, 0);
        }
    ...
    public static class ExistsQueryContext extends ParserRuleContext {
        ...
        public TerminalNode WILDCARD() {
            return getToken(KqlBaseParser.WILDCARD, 0);
        }
    ...
    public static class FieldQueryValueContext extends ParserRuleContext {
        public List<TerminalNode> AND() {
            return getTokens(KqlBaseParser.AND);
        }
        ...
        public List<TerminalNode> OR() {
            return getTokens(KqlBaseParser.OR);
        }
        ...
        public List<TerminalNode> NOT() {
            return getTokens(KqlBaseParser.NOT);
        }
    ...
    public static class FieldNameContext extends ParserRuleContext {
        ...
        public TerminalNode UNQUOTED_LITERAL() {
            return getToken(KqlBaseParser.UNQUOTED_LITERAL, 0);
        }
